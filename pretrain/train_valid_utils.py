...
def init_args():
    ...
    parser.add_argument('--data_dir', default = '/home/shenguanlin/geolayout_pretrain', type = str)
    ...
    parser.add_argument('--weight_depth', default = 0.2, type = float)
...
def init_model(args):
    ...
    model = DORN(channel = 5, output_channel = 2 * args.ord_num + 5)
